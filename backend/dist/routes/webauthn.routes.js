...
import { checkBiometricCredentials, generateAuthenticationOptions, generateRegistrationOptions, verifyAuthentication, verifyRegistration, } from "../controllers/webauthn.controller.js";
const router = Router();
