...
export async function login(input) {
    ...
    if (user.role === "STAFF") {
        ...
        if (activeDevice && incomingHash && activeDevice.tokenHash === incomingHash) {
            ...
            const now = new Date();
            const hasValidApproval = user.deviceResetAllowed === true &&
            ...
            if (hasValidApproval) {
            ...
            else if (user.deviceResetAllowed === true &&
                ...
                // No valid approval
                throw new AppError(403, "Device not registered. Please contact your admin for approval.", "STAFF_DEVICE_NOT_REGISTERED");
            }
        }
        else {
            throw new AppError(403, "Device not registered. Please contact your admin for approval.", "STAFF_DEVICE_NOT_REGISTERED");
